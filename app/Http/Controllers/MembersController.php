...
class MembersController extends Controller
{
    ...
    //  //login
     public function login(Request $request)
     {
         ...
         $users = Member::where($condition)->first();
    ...
    //    if (empty($users->p_img) == false) {
    //         // ลบไฟล์เดิมทิ้ง ซึ่งซื้อไฟล์อยู่ในฟิวด์ p_img
    //        if (file_exists("/home/user4/foodapp/public/img/".$product->p_img)) {
    //            unlink("/home/user4/foodapp/public/img/".$users->p_img);
    //        }
    //    } 
    ...
    //       if($value->p_img != null) {
    //         $products[$i]['p_img'] = urlencode("http://".$ip_server."/user4/img/".$value->p_img);
    //     }
    //       $i++;
    //     }
    ...
    //     $product->p_img  = urlencode("http://".$ip_server."/user4/img/".$product->p_img);
    //     }
